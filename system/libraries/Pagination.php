...
class CI_Pagination {
	...
	var $cur_tag_open		= '<div class="current">';
	...
	function create_links()
	{
		...
		if ($CI->config->item('enable_query_strings') === TRUE OR $this->page_query_string === TRUE)
		{
			if ($CI->input->get($this->query_string_segment) != $base_page)
			{
				...
				//echo '<br/>';
				//echo $CI->config->item('enable_query_strings');
				//echo 'dupa';
				//echo $this->query_string_segment;
		...
		{
			if ($CI->uri->segment($this->segment) != $base_page)
			//if ($CI->uri->segment($this->uri_segment) != $base_page)
			{
				//$this->cur_page = $CI->uri->segment($this->uri_segment);
				$this->cur_page = $CI->uri->segment($this->segment);
				//echo '<br/>';
				//echo $this->uri_segment;
				//echo $this->cur_page;
